  ...
  return (
    <Tabs defaultValue="all" className="w-full">
      <TabsList className="grid w-full grid-cols-3 mb-6">
        <TabsTrigger value="all" className="data-[state=active]:bg-green-200 data-[state=active]:text-green-800">All</TabsTrigger>
        <TabsTrigger value="oncology" className="data-[state=active]:bg-green-200 data-[state=active]:text-green-800">Oncology</TabsTrigger>
        <TabsTrigger value="psychology" className="data-[state=active]:bg-green-200 data-[state=active]:text-green-800">Psychology</TabsTrigger>
      </TabsList>
