    ...
    <footer className="w-full border-t py-6 md:py-0 bg-green-800 text-white">
      <div className="container flex flex-col md:flex-row items-center justify-between gap-4 md:h-24 px-4 md:px-6 max-w-7xl mx-auto">
        <p className="text-center text-sm leading-loose md:text-left">
          © {new Date().getFullYear()} IEEE IAS PES ISIMM Student Branch Joint Chapter. All rights reserved.
        </p>
        <div className="flex items-center gap-4">
          ...
          <a href="https://www.linkedin.com/company/ieee-ias-pes-isimm-sbjc/" target="_blank" rel="noopener noreferrer" className="text-sm font-medium hover:text-blue-500 transition-colors">
